 ...
 * @description Aceternity auto-hiding floating navbar. Uses framer-motion useScroll to hide on scroll-down and reveal on scroll-up. Pill-shaped with icons + labels and a trailing Login CTA.
 * @usage Use for content-heavy pages (blogs, long landing pages, docs) where you want an unobtrusive navbar that reappears when the user scrolls back up.
 * @props navItems=[{name, link, icon?}], className. Pair with FloatingNavDemo as a reference.
 */
